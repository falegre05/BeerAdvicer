...
public class AdvancedClientTask extends AsyncTask<String, Void, Integer> {

    private final static String TAG = "AdvancedClientTask";
    ...
    public AdvancedClientTask(MainActivity activity) {
    ...
    protected void onPostExecute(Integer integer) {
        ...
        mActivity.advancedSearchDone(integer);
    }
